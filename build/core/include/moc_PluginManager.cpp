...
#include "../../../core/include/PluginManager.h"
...
QT_MOC_LITERAL(1, 14, 13), // "pluginsLoaded"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "PluginManager\0pluginsLoaded\0"
};
...
void PluginManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PluginManager::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PluginManager::pluginsLoaded)) {
                *result = 0;
                return;
            }
        }
