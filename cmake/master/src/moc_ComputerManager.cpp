...
#include "../../../master/src/ComputerManager.h"
...
QT_MOC_LITERAL(1, 16, 22), // "computerSelectionReset"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 24), // "computerSelectionChanged"
QT_MOC_LITERAL(4, 65, 16), // "checkChangedData"
QT_MOC_LITERAL(5, 82, 7), // "topLeft"
QT_MOC_LITERAL(6, 90, 11), // "bottomRight"
QT_MOC_LITERAL(7, 102, 12), // "QVector<int>"
QT_MOC_LITERAL(8, 115, 5) // "roles"

    },
    "ComputerManager\0computerSelectionReset\0"
    "\0computerSelectionChanged\0checkChangedData\0"
...
void ComputerManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->computerSelectionReset(); break;
        case 1: _t->computerSelectionChanged(); break;
        case 2: _t->checkChangedData((*reinterpret_cast< const QModelIndex(*)>(_a[1])),(*reinterpret_cast< const QModelIndex(*)>(_a[2])),(*reinterpret_cast< const QVector<int>(*)>(_a[3]))); break;
        default: ;
        }
        ...
        {
            typedef void (ComputerManager::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ComputerManager::computerSelectionReset)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ComputerManager::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ComputerManager::computerSelectionChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ComputerManager::computerSelectionReset()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void ComputerManager::computerSelectionChanged()
{
